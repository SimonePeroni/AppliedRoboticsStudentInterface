...
namespace utils
{
    ...
    public:
        ...
        void plotEdges(const rm::RoadMap &rm, std::string style = "b--");
        void plotGraph(const rm::RoadMap &rm, std::string node_style = "bo", std::string edge_style = "b--");
        ...
        void plotDiscretePath(const std::vector<Pose> path, std::string style = "g.");
    };
}