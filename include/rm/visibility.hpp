...
namespace rm
{
     ...
     * 
     * @param roadmap   Out: The result is stored in the base directed graph of the roadmap.
     * @param points    Vertices to be included in the graph
     * @param obstacles Obstacles for collision checking
     * @param borders   Borders of the arena for collision checking
     * 
     * @see rm#RoadMap
     */
     ...
     * 
     * @param obstacles Source obstacles
     * @param borders   Borders of the arena, considered as obstacles
     * @param offset    Inflation value of the obstacles.
     * @param nodes     Out: vector of selected vertices
     * @param threshold Optional: minimum distance between consecutive nodes
     */
